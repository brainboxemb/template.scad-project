...
For `tool.scad-project`, `project.yml` and reusable workflow callers use the same released semantic ref such as `v0.14.7`; the committed gitlink records the exact source commit resolved for that release.
